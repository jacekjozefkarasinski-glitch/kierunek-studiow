      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-6 py-14 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[1fr_0.8fr]">
            <div>
              ...
              <div className="mt-8 space-y-6">
                <div className="flex gap-4">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#08265c] text-sm font-semibold text-white">
                    1
                  </div>
            ...
            {/* CTA */}
            <div className="rounded-3xl bg-[#e9c93e] p-8 text-[#08265c]">
              ...
              <a
                ...
                className="mt-7 inline-flex rounded-full bg-[#08265c] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#113b82]"
              >
                Otwórz IRK ↗
              </a>
            </div>
